  ...
  <body style="">
   ...
   <?php echo "<li class='dropdown'>
                ...
                <ul class='dropdown-menu'>
                  <li><a href='./profile.php'>You are logged in as: <p>".$_SESSION['username']."</p></a></li>
				...
				echo "<div class='col-sm-4'>".
					  ...
					  "<form method='post' class='panel panel-info'>".
							"<div class='panel-heading'>".
							 "<input disabled type='text' id = 'title' name='card_title_edit' class='form-control cardTitle' placeholder='Title' autocomplete='off' required='' autofocus='' value='".$full_title."'>".
                                                         "</div>".
							"<div class='panel-body' style='padding:10px'>".
							  "<textarea disabled type='text' id = 'message' name='card_message' class='form-control' placeholder='Message' required='' style='resize:none; height: 65px; margin-bottom:5px'>".$card_message."</textarea>".
...
<?php
					...
					while ($res and $row = mysql_fetch_array($res, MYSQL_ASSOC)) {
						echo "<div class='well'  style='padding:30px'>".
						  "<textarea type='text' id = 'message' name='comment_message_message' class='form-control' placeholder='Comment' required='' style='resize:none; height: 65px; margin-bottom:5px'>".$row['comment_message']."</textarea>".
							  "<button class='btn btn-sm btn-primary' type='submit' name='submit' style='float:right'>Save</button>".
							"</div>";
