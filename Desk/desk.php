						...
						echo "<div class='col-sm-4' >".
								"<div class='panel panel-info' draggable='true' ondragstart='drag(event)' id='cardPost".$row["card_id"]."'>".
									"<div class='panel-heading' style='white-space:nowrap' id='".$row["card_id"]."'>".
										"<a href='card.php?subject=".$subject."&cardID=".$row["card_id"]."' ><h3 class='panel-title' style='white-space:nowrap; overflow:hidden; text-overflow:ellipsis; width: 100%;'>".$row["card_title"]."</h3></a>".
									"</div>".
									"<div class='panel-body timestamp'>".$newDate."</div>".
